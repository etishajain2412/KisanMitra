        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-gray-800">KisanMitra</span>
            </div>
            <p className="text-gray-600 mb-4">
              Empowering farmers across India with knowledge, resources, and community support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#testimonials" className="text-gray-600 hover:text-green-600">Success Stories</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-green-600">Farming Guides</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600">Government Schemes</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600">Market Prices</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600">Weather Forecasts</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600">Crop Calendar</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} KisanMitra. All rights reserved.
            </p>
