...
import { Storefront, VideoLibrary, Forum, HistoryEdu, Cloud, Settings, Menu, ShoppingCart } from "@mui/icons-material";
      ...
      <Navbar expand="lg" className="navbar navbar-dark bg-dark">
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav">
            ...
            <Button onClick={() => navigate('/login')} className="btn btn-primary ms-3">
              {t("login")}
            </Button>
            <Button onClick={() => navigate('/register')} className="btn btn-success ms-3">
              {t("register")}
            </Button>
          </Navbar.Collapse>
        </Container>
